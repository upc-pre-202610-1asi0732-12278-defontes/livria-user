...
Al registrarte o usar el Servicio declaras haber leído y aceptado estos Términos y la Política de privacidad. Si no estás de acuerdo, no utilices el Servicio.

1. Definiciones
• Servicio / Plataforma: la aplicación Livria y sus funciones (catálogo, carrito, pedidos, perfil, comunidades, notificaciones, etc.).
• Usuario o Cliente: persona natural que crea una cuenta y utiliza el Servicio.
• Contenido: información y materiales mostrados en la Plataforma (textos, imágenes, etc.). Los libros ofrecidos a la venta en la versión actual del Servicio son principalmente ejemplares físicos sujetos a disponibilidad y a la Zona de cobertura indicada más abajo.
• Pedido: solicitud de compra de productos realizada a través de la Plataforma.
• Zona de cobertura (entrega física): Lima Metropolitana, Perú, salvo indicación distinta en el flujo de compra.

2. Cuenta y seguridad
Debes proporcionar datos veraces y mantener la confidencialidad de tu usuario y contraseña. Eres responsable de las actividades realizadas con tu cuenta. Notifica de inmediato cualquier uso no autorizado.
...
Podrás conceder o denegar permisos según el sistema operativo:
• Cámara y galería: para foto de perfil y, cuando la funcionalidad lo permita, imágenes en comunidades u otro contenido que tú publiques.
• Ubicación: solo en relación con funciones que lo requieran (por ejemplo, mapa de tienda o rutas).

6. Pagos (transferencia interbancaria – CCI)
6.1 Los pagos de productos o del plan de comunidades se realizan mediante transferencia bancaria manual al CCI e instrucciones mostradas en la aplicación (checkout o flujo de suscripción/comprobante). Livria no integra pasarelas de pago con tarjeta dentro de la app para esos cobros y no almacena número completo de tarjeta ni CVV para ese fin.
6.2 Eres responsable de realizar la transferencia correctamente y en los plazos indicados. En planes periódicos, cada renovación depende del cumplimiento del pago según lo mostrado en la app.
6.3 Comisiones u omisiones de tu banco son ajenas a Defontes salvo lo que imponga la ley imperativa.

7. Pedidos y logística
Los estados del pedido (pendiente, en proceso, enviado, entregado, etc.) pueden actualizarse de forma operativa por el equipo; no se garantiza rastreo GPS en tiempo real ni integración con terceros de courier salvo que se indique expresamente en la app.

La entrega de libros físicos se circunscribe a la Zona de cobertura. Fuera de ella, Defontes no está obligada a procesar entregas físicas.

8. Planes y comunidades
El Servicio puede incluir un plan gratuito y un plan de pago para funciones de comunidades (según lo mostrado en la app). Las funciones concretas pueden actualizarse; las modificaciones sustanciales de estos Términos se comunicarán con la antelación legal y/o contractual prevista en el acuerdo marco.

9. Propiedad intelectual
La marca, diseño y software de Livria son de Defontes o sus licenciantes. Los derechos sobre las obras comercializadas corresponden a autores y editoriales; Livria actúa como intermediario en la medida que corresponda.

10. Suspensión y terminación
Podemos suspender o terminar el acceso ante incumplimientos graves o por las causas previstas en la normativa y en el acuerdo marco.

11. Limitación de responsabilidad
En la medida máxima permitida por la ley peruana, Defontes no responde por daños indirectos o lucro cesante salvo disposición legal en contrario. El Servicio se ofrece «tal cual» y «según disponibilidad».

12. Ley y jurisdicción
Estos Términos se rigen por las leyes del Perú. Las controversias se someten a los tribunales competentes de Lima, salvo norma imperativa en contrario.
...
Defontes S.A.C., Lima Metropolitana, Perú. Contacto: support@defontes.com

2. Datos que podemos tratar
• Identificación y cuenta: nombre o apodo visible, correo, usuario, contraseña (almacenada de forma protegida en nuestros sistemas), datos de perfil que nos proporciones.
• Pedidos: dirección o datos de entrega, ciudad (por ejemplo Lima Metropolitana), información necesaria para gestionar el pedido y el pago por transferencia.
